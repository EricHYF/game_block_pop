...
namespace GKIT.Editor
{
    ...
    {
        public const string K_EDITOR_MENU_ROOT = "GKIT";
        public const string K_RESOURCES_PATH = "ResourceG";
        public const string K_TITLE_NAME = "G资管管理器";
        ...
        public static string CachedBuildDataBin => Path.Combine(K_GRES_CACHE_ROOT, ActiveBuildTargetName, ActiveProfileName, K_BUILD_DATA_BIN_NAME);
        ...
        /// 备份现有构建数据
        /// </summary>
        private static  void BackupBuildData()
        {
        ...
        private static  void UpdateGroups(DirectoryInfo dir)
        {
            if (dir.Exists)
            {
        ...
        public static void BuildBundles(bool makeNewBuild = true)
        {
            CleanServerData();
        ...
        public static  void MakeNewBuild()
        {
            AddressableAssetSettings.BuildPlayerContent();
            if(!IsCachedBuildDataExists) BackupBuildData();
        }
        ...
        public static  void UpdateExistBuild()
        {
            CleanBuildAll();
